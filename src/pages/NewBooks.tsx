            ...
            <div className="text-center py-16">
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-2xl font-bold text-foreground mb-4">
                  {searchQuery ? `No new books found for "${searchQuery}"` : "No new books found"}
                </h3>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  We couldn't find any new books matching your criteria. But don't worry! 
                  Our team can help you find the latest releases you're looking for.
                </p>
