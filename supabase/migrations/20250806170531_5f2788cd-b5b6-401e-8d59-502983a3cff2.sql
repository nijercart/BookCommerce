-- Drop the existing hero_images table if it exists
DROP TABLE IF EXISTS public.hero_images CASCADE;

-- Create new hero_images table for device-specific backgrounds
...
-- Insert default hero images using the generated assets
